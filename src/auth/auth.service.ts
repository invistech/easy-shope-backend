...
export class AuthService {
  ...
  async createAdminServiceFn(data) {
    ...
    if (await findAdminEmail.length === 0 && await findAdminUsername.length === 0) {
  ...
  async loginAdminServiceFn(data: LoginAdminUserAuthDto): Promise<IValidCridential> {
